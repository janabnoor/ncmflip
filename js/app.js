...
import { animateFlip, instantSetAngle, resolveDragFlip, setDragProgress } from './flip-engine.js';
import { ensurePageRendered, getActiveWindow, unloadPage } from './lazy-loader.js';
import { getPageDimensions, loadPdf } from './pdf-renderer.js';
import { initSoundEngine, playPageTurn, toggleMuted, unlockAudio } from './sound-engine.js';
import { attachGestures } from './touch-controls.js';
import { getZoom, onZoomChange, setRawZoom, snapToNearestLevel, toggleDoubleTapZoom, zoomIn, zoomOut } from './zoom-controls.js';
